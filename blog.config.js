...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'jiaoyi.pro', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jiaoyi.pro', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'jiaoyi,短线交易,博客', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,email,facebook,twitter,line,reddit', // 分享的服務，按顺序显示,逗号隔开
