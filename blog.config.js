...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'tradeway', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tradeway.top', // 网站地址
  ...
  WIDGET_PET_SWITCH_THEME:
    process.env.NEXT_PUBLIC_WIDGET_PET_SWITCH_THEME || flase, // 点击宠物挂件切换博客主题
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'tradeway.top 交易小道 分享关于交易的思考', // 站点描述，被notion中的页面描述覆盖
